                    ...
                    <form name="edit_form" id="edit_form" action="tag_edit_ajax.php" data-toggle="validator" role="form">
                        ...
                        <div class="card">
                            ...
                            <div class="card-footer">
                                <button type="button" class="btn btn-warning float-left" onclick="javascript:location.href='tag2_list.php'">取消</button>
    ...
    function ajaxCallback(status,form,json,options){
        if(status===true){
            if(json.sResult==true)
                success_alert("菜色標籤<?= $sub_title ?>","tag2_list.php");
            else
