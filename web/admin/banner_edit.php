                    ...
                    <form name="edit_form" id="edit_form" action="banner_edit_ajax.php" data-toggle="validator" role="form">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-11">
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="pic_url" name="pic_url" class="form-control" value="<?= $pic_url ?>" placeholder="建議尺寸1920*600" readonly>
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-5">
                                        <div class="radio">
                                            <label>
                                                <input type="radio" name="blank" id="blank0" class="square-red" value="0" <?= ($blank == 0) ? "checked" : ""; ?>>
                                                <span class="badge bg-success">否</span>
                                            </label>
                                            <label>
                                                <input type="radio" name="blank" id="blank1" class="square-red" value="1" <?= ($blank == 1) ? "checked" : ""; ?> >
                            ...
                            <div class="card-footer">
                                <button type="button" class="btn btn-warning float-left" onclick="javascript:location.href='banner_list.php'">取消</button>
    ...
    function ajaxCallback(status,form,json,options){
        if(status===true){
            if(json.sResult==true)
                success_alert("首頁Banner<?= $sub_title ?>","banner_list.php");
            else
