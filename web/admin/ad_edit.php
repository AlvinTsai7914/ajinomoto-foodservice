...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="row">
                <div class="col-12">
                    <form name="edit_form" id="edit_form" action="ad_edit_ajax.php" data-toggle="validator" role="form">
                        ...
                        <div class="card">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-11">
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="pic_url" name="pic_url" class="form-control" value="<?= $pic_url ?>" placeholder="建議尺寸500*165" readonly>
                            ...
                            <div class="card-footer">
                                <button type="button" class="btn btn-warning float-left" onclick="javascript:location.href='ad_list.php'">取消</button>
    ...
    function ajaxCallback(status,form,json,options){
        if(status===true){
            if(json.sResult==true)
                success_alert("首頁廣告<?= $sub_title ?>","ad_list.php");
            else
