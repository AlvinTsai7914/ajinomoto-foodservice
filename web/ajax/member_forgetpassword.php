...
//註冊成功發送Email
if ($sResult == true) {
    if (SendMemberResetPasswordVerificationMail($member_account, $resultData[0]['id'], $resultData[0]['verification']) == true)
        $resultMessage = "重設密碼信發送成功";
    else
        $resultMessage = "重設密碼信發送失敗";
}
